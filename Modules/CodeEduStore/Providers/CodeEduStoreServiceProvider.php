...
class CodeEduStoreServiceProvider extends ServiceProvider
{
    ...
    {
        $sourcePath = 'C:\Users\rael\Projects\editora\Modules\CodeEduStore\resources\img';
        $sourcePathSass = 'C:\Users\rael\Projects\editora\Modules\CodeEduStore\resources\sass';
        $this->publishes([
            $sourcePath => public_path('img'),
            $sourcePathSass => public_path('resources/assets/sass')
        ], 'assets');
    }
